...
import com.techinnovation.arrangingseats.security.jwt.AuthTokenFilter;
...
//  private final JwtService jwtService;
  ...
  //   return new AuthTokenFilter(jwtService, userService, null);
  // }
  ...
  public SecurityFilterChain filterChain(HttpSecurity http)
    ...
    http.csrf(csrf -> csrf.disable())
      ...
      .authorizeHttpRequests(
        auth -> auth.requestMatchers(antMatcher("/api/auth/**")).permitAll()
                .requestMatchers(antMatcher("/v3/api-docs/**"), antMatcher("/swagger-ui/**")).permitAll()
